# Sol Browser Contributor License Agreement

Thank you for your interest in contributing to Sol Browser, a project by Computer Motivators ("We" or "Us").
...
"**You**" means the individual or legal entity including its affiliates that is making this Agreement with Us.
...
Based on the grant of rights in Sections 2.1 and 2.2, if We include Your Contribution in a Material, We may license the Contribution under any license, including copyleft, permissive, commercial, or proprietary licenses. As a condition on the exercise of this right, We agree to also license the Contribution under the terms of the license or licenses which We are using for the Material on the Submission Date (currently AGPL-3.0).

## 3. Disclaimer

EXCEPT FOR THE EXPRESS WARRANTIES IN SECTION 4, THE CONTRIBUTION IS PROVIDED "AS IS". MORE PARTICULARLY, ALL EXPRESS OR IMPLIED WARRANTIES INCLUDING, WITHOUT LIMITATION, ANY IMPLIED WARRANTY OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT ARE EXPRESSLY DISCLAIMED BY YOU TO US AND BY US TO YOU. TO THE EXTENT THAT ANY SUCH WARRANTIES CANNOT BE DISCLAIMED, SUCH WARRANTY IS LIMITED IN DURATION TO THE MINIMUM PERIOD PERMITTED BY LAW.
...
(d) You have followed the instructions in Sol Browser's Contribution Guidelines with respect to Your Contribution.

## Signing

To sign this CLA, please comment on your first Pull Request with the following statement:

```
I have read the CLA Document and I hereby sign the CLA
```

Our CLA bot will record your signature and you will only need to do this once.
